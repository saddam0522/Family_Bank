...
from .constant import ACCOUNT_TYPE,GENDER_TYPE,ACCOUNT_NO
...
class UserRegistrationForm(UserCreationForm):
    ...
    class Meta:
        ...
        'email','account_type','birth_date','gender','street_address','city','postal_code','country']
    ...
    def save(self,commit=True):
        ...
        if commit == True:
            ...
            account_no = ACCOUNT_NO[account_type] + our_user.id,           
